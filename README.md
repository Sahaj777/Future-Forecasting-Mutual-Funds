...
Pre-Requisite
==============
Project required Mutual fund scheme code, *[here](https://github.com/Sahaj777/Future-Forecasting-Mutual-Funds/blob/main/codes.json)* you can get those. 
...
2. Run main.py 
```shell
  >>/Future-Forecasting-Mutual-Funds> python main.py
```
...
Crypto Prediction
================
Prediction of Forcasting Cryptocurrency in INR *[here](https://github.com/Sahaj777/Forecasting-Cryptocurrency-Prices-INR)*
